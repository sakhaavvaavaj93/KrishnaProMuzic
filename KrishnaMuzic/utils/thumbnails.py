...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("KrishnaMuzic/assets/font2.ttf", 30)
        font = ImageFont.truetype("KrishnaMuzic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("KrishnaMuzic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("KrishnaMuzic/assets/play_icons.png")
