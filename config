...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/sakhaavvaavaj93/KrishnaProMuzic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Puranam_00")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/KURUK_SHE_TRA")
